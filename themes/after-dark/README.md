...
<p align="center">
  <img src="https://git.habd.as/comfusion/after-dark/raw/branch/master/images/docs/minimal-mac.png" title="After Dark running on a MacBook and iPhone" alt="After Dark theme screenshots">
</p>
...
<p align="center">
  ...
  <a href="https://git.habd.as/comfusion/after-dark/src/branch/master/COPYING"><img src="https://img.shields.io/badge/license-BTC-green.svg?longCache=true&style=flat-square" alt="Project license"></a>
</p>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Predictable changes enable theme users stay up-to-date with what's happening. After Dark uses <a target="feature" href="http://semver.org/">Semantic Versioning</a> and maintains a <a target="feature" href="https://git.habd.as/comfusion/after-dark/src/branch/master/CHANGELOG.md">CHANGELOG</a> for easy consumption.</td>
      </tr>
      <tr>
...
![Syntax Highlighting screenshot](https://git.habd.as/comfusion/after-dark/src/branch/master/images/docs/feat-syntax-highlighting.png "Syntax Highlighting using Atom One Pygments and Chroma")
